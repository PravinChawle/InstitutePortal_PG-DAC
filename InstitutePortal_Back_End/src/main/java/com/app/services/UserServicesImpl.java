...
public class UserServicesImpl {
	...
	public boolean uploadImage(ProfilePicDTO propic)
	{
		...
		try {
		FileCopyUtils.copy(propic.getProfilePic().getInputStream(), new FileOutputStream("F:\\Pravin CDAC\\Project\\ProjectImp\\"+filename));
		}
		catch(IOException e)
		{
			e.printStackTrace();
	...
	public byte[] getImage(int id)throws IOException
	{
		...
		String path = "F:\\Pravin CDAC\\Project\\ProjectImp\\"+user.getProfilePic();
		try {
